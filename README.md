...
```html
<script src="https://static.mathigon.org/api/polypad-v1.7.js"></script>
...
Note: the `polypad-v1.7.js` script needs to be included in the `<body>`, not the `<head>` of your HTML document.
